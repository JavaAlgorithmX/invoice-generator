...
//       setData({ ...data, customerName: '', customerAddress: '', customerPhone: '', customerGSTIN: '' });
//     }
//   };
...
//   const generatedFileName = `${safeCustomerName}_${data.date}.pdf`;
...
//                   Customer Name <span className="text-red-600 text-lg leading-none">*</span>
//                 </label>
