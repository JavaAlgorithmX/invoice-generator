...
const styles = StyleSheet.create({
  ...
  // FIX: Header is now relative, allowing the logo to float without stretching the height
  header: { position: 'relative', marginBottom: 10 },
  
  // FIX: Logo is absolutely positioned in the top left corner
  logoSpace: { position: 'absolute', top: 0, left: 0, width: 70, height: 70 }, 
  
  // FIX: Added marginHorizontal to keep text centered but prevent it from overlapping the floating logo
